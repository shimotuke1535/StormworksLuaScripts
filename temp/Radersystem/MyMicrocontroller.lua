...
do
    ...
    simulator:setProperty("LimitRange", 1000)
    ...
    function onLBSimulatorTick(simulator, ticks)
        ...
        simulator:setInputNumber(2, simulator:getSlider(2) * (2 * math.pi))
        simulator:setInputNumber(3, simulator:getSlider(3))
        simulator:setInputNumber(4, simulator:getSlider(4) * 20)
        simulator:setInputNumber(32, simulator:getSlider(5) * 100)
    end;
end
---@endsection
